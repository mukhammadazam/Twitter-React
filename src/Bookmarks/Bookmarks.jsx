...
const Bookmarks = () => {
  return (
   <div>
     <div>
      <p className="h4 m-0 text-start">
      Bookmarks
      </p>
      <Link to='https://twitter.com/i/bookmarks' target="_blank" className="text-decoration-none text-dark">@MuhammadazamRi5</Link>
    ...
    <div className="book">
     ...
     <p className="book__title text-center">
