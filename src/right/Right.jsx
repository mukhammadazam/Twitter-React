  ...
  return (
    <div className='right flex-1'>
      ...
      <div className='right__bottom'>
        <h4 className='right__bottom--title'>You might like</h4>
        <div className=' d-flex align-items-center '>
          ...
          <button
            onClick={funCount8}
            className={`d-block right__bottom--btn ${
              counter8 ? "d-block" : "d-none"
            }`}>
            Follow
          </button>
          <button
            onClick={funCount8}
            className={`d-block right__bottom--btn position-absolute end-0 ${
              counter8 ? "d-none" : "d-block right__bottom--btn--bg"
            }`}>
            Following
          </button>
        </div>
        <div className=' pt-3 d-flex align-items-center  '>
          ...
          <button
            onClick={funCount9}
            className={`right__bottom--btn ${
              counter9 ? "d-block " : "d-none btn--bg"
            }`}>
            Follow
          </button>
          <button
            onClick={funCount9}
            className={`right__bottom--btn position-absolute end-0 ${
              counter9 ? "d-none " : "d-block right__bottom--btn--bg"
            }`}>
            Following
          </button>
        </div>
